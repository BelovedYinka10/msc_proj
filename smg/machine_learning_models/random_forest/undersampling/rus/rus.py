...
print("🚀 Random Forest with RUS Sampling - Optimized Workflow")
print("="*70)
...
print(f"\n⏳ Training Random Forest model on RUS-resampled data...")
...
print("\n" + "="*60)
print("🎯 RANDOM FOREST + RUS RESULTS")
print("="*60)
...
fig.update_layout(
    title={
        'text': 'Confusion Matrix - Random Forest + RUS',
        'x': 0.5,
        'xanchor': 'center',
...
print(f"   - Random Forest + RUS (this experiment)")
print(f"   - XGBoost + RUS (next?)")
print(f"   - Decision Tree + RUS (next?)")

print(f"\n🎉 Random Forest + RUS experiment completed successfully!")
