...
print("🚀 Random Forest with NearMiss Sampling - Optimized Workflow")
print("="*70)
...
print(f"\n🎲 Applying NearMiss Under-sampling...")
...
print(f"\n⏳ Training Random Forest model on NearMiss-resampled data...")
...
print("\n" + "="*60)
print("🎯 RANDOM FOREST + NEARMISS RESULTS")
print("="*60)
...
fig.update_layout(
    title={
        'text': 'Confusion Matrix - Random Forest + NearMiss',
        'x': 0.5,
        'xanchor': 'center',
...
print(f"   - Random Forest + NearMiss (this experiment)")
print(f"   - XGBoost + NearMiss (next?)")
print(f"   - Decision Tree + NearMiss (next?)")

print(f"\n🎉 Random Forest + NearMiss experiment completed successfully!")
