...
print("🚀 Random Forest with ClusterCentroids Sampling - Optimized Workflow")
print("="*70)
...
# ============================================
# APPLY CLUSTER CENTROIDS SAMPLING
# ============================================

print(f"\n🎲 Applying ClusterCentroids Under-sampling...")
...
print(f"\n⏳ Training Random Forest model on ClusterCentroids-resampled data...")
...
print("\n" + "="*60)
print("🎯 RANDOM FOREST + CLUSTER CENTROIDS RESULTS")
print("="*60)
...
fig.update_layout(
    title={
        'text': 'Confusion Matrix - Random Forest + ClusterCentroids',
        'x': 0.5,
        'xanchor': 'center',
...
print(f"   - Random Forest + ClusterCentroids (this experiment)")
print(f"   - XGBoost + ClusterCentroids (next?)")
print(f"   - Decision Tree + ClusterCentroids (next?)")

print(f"\n🎉 Random Forest + ClusterCentroids experiment completed successfully!")
