...
print("🚀 Random Forest with ADASYN Sampling - Optimized Workflow")
print("="*70)
...
print(f"\n⏳ Training Random Forest model on ADASYN-resampled data...")
...
print("\n" + "="*60)
print("🎯 RANDOM FOREST + ADASYN RESULTS")
print("="*60)
...
fig.update_layout(
    title={
        'text': 'Confusion Matrix - Random Forest + ADASYN',
        'x': 0.5,
        'xanchor': 'center',
...
print(f"   - Gradient Boosting + ADASYN")
print(f"   - Random Forest + ADASYN (this experiment)")
print(f"   - XGBoost + ADASYN (next?)")
print(f"   - Decision Tree + ADASYN (next?)")

print(f"\n🎉 Random Forest + ADASYN experiment completed successfully!")