...
print("🚀 Random Forest with ROS (Random OverSampler) - Optimized Workflow")
print("="*70)
...
print(f"\n⏳ Training Random Forest model on SMOTE-resampled data...")
...
fig.update_layout(
    title={
        'text': 'Confusion Matrix - Random Forest + SMOTE',
        'x': 0.5,
        'xanchor': 'center',
...
print(f"   - Random Forest + SMOTE (this experiment)")
print(f"   - XGBoost + SMOTE (next?)")
print(f"   - Decision Tree + SMOTE (next?)")

print(f"\n🎉 Random Forest + SMOTE experiment completed successfully!")