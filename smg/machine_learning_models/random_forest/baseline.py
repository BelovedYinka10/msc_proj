...
with open('best_rf_hyperparameters.json', 'r') as f:
    saved = json.load(f)
...
print("\n⏳ Training Random Forest (final fit only)...")
...
plt.title("Random Forest (Final Fit) — Confusion Matrix")
plt.show()
...
print("\n✅ Saved run metrics to 'rf_baseline_results.json'")
