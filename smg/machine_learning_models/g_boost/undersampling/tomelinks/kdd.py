...
# Now with TomekLinks undersampling inserted into the pipeline.
...
# NEW: TomekLinks (undersampling/cleaning)
...
# -------- TomekLinks (undersampling/cleaning) --------
# Removes majority samples that form Tomek links with minority samples (cleans decision boundary).
...
# -------- train & predict --------
print("\n⏳ Training (5-class with GradientBoosting + TomekLinks)...")
...
plt.title("Gradient Boosting + TomekLinks — NSL-KDD 5-class (pre-grouped CSVs)")
plt.tight_layout()
plt.show()
