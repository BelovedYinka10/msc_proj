...
# Now with NearMiss undersampling inserted into the pipeline.
...
# version=1 keeps majority samples closest to minority (tightens boundary).
# Default sampling_strategy='auto' reduces each majority class to the minority count (aggressive).
...
# -------- train & predict --------
print("\n⏳ Training (5-class with GradientBoosting + NearMiss)...")
...
plt.title("Gradient Boosting + NearMiss — NSL-KDD 5-class (pre-grouped CSVs)")
plt.tight_layout()
plt.show()
