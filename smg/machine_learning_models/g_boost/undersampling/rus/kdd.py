...
# Default 'sampling_strategy="auto"' reduces every majority class down to the MINORITY count (aggressive).
# If you want a gentler drop (e.g., down to Probe size), we can pass a dict without changing other structure.
...
# -------- train & predict --------
print("\n⏳ Training (5-class with GradientBoosting + RUS)...")
...
plt.title("Gradient Boosting + RUS — NSL-KDD 5-class (pre-grouped CSVs)")
plt.tight_layout()
plt.show()
