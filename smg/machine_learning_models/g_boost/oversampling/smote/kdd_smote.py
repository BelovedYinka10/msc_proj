...
# Now with SMOTE inserted into the pipeline.
...
# -------- SMOTE --------
# Default 'sampling_strategy="auto"' oversamples all minority classes to the majority.
# If you prefer targeting only U2R/R2L or capping counts, we can pass a dict.
...
# -------- train & predict --------
print("\n⏳ Training (5-class with GradientBoosting + SMOTE)...")
...
plt.title("Gradient Boosting + SMOTE — NSL-KDD 5-class (pre-grouped CSVs)")
plt.tight_layout()
plt.show()
