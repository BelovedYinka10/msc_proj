...
# Default 'sampling_strategy="not_majority"' oversamples all minority classes up to the majority count.
# If you want to target only U2R/R2L or cap amounts, tell me and I’ll plug a dict here.
...
# -------- train & predict --------
print("\n⏳ Training (5-class with GradientBoosting + ROS)...")
...
plt.title("Gradient Boosting + ROS — NSL-KDD 5-class (pre-grouped CSVs)")
plt.tight_layout()
plt.show()
