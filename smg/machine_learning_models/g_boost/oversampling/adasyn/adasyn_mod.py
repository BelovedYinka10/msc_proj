...
print("🚀 Gradient Boosting with ADASYN Sampling - Optimized Workflow")
print("="*70)
...
best_cv_score = 0.9096550109042351
...
try:
    ...
    print(f"✅ ADASYN sampling completed successfully!")
...
print(f"\n🔧 Creating optimal Gradient Boosting classifier...")

# Create classifier with optimal hyperparameters
optimal_classifier = GradientBoostingClassifier(
...
print(f"✅ Classifier created with optimal hyperparameters")

# ============================================
# TRAIN MODEL ON RESAMPLED DATA
# ============================================

print(f"\n⏳ Training model on ADASYN-resampled data...")
...
print("\n" + "="*60)
print("🎯 GRADIENT BOOSTING + ADASYN RESULTS")
print("="*60)
...
fig.update_layout(
    title={
        'text': 'Confusion Matrix - Gradient Boosting + ADASYN',
        'x': 0.5,
        'xanchor': 'center',
...
print(f"\n✅ Ready for comparison with other sampling techniques!")
print(f"💡 Next steps:")
print(f"   - Run same code with SMOTE, BorderlineSMOTE, etc.")
print(f"   - Compare F1-scores across different sampling methods")
print(f"   - Use same optimal hyperparameters for fair comparison")
