# nsl_kdd_dt_randomsearch.py
# Hyperparameter search for Decision Tree on NSL-KDD (5-class pre-grouped CSVs)
...
param_dist = {
    ...
    "clf__max_depth": [3, 5, 10, 15, 20, 25, 30, None],
    "clf__min_samples_split": [2, 5, 10, 15, 20, 25],
    "clf__min_samples_leaf": [1, 2, 4, 6, 8, 10],
    "clf__max_features": [None, "sqrt", "log2"],
    "clf__class_weight": [None, "balanced"],
    "clf__splitter": ["best", "random"],
    "clf__max_leaf_nodes": [None, 50, 100, 150, 200, 300]
}
...
# ----------- randomized search -----------
print("\n⏳ Starting RandomizedSearchCV (Decision Tree on NSL-KDD 5-class)...")
t0 = time.time()
...
out = {
    ...
    "notes": "Preprocessing: OHE for categorical (protocol_type, service, flag), MinMax+median impute for numerics."
}

with open("kdd_best_dt_hyperparameters.json", "w") as f:
