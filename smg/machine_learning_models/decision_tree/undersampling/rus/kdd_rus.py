...
# Uses pre-made 5-class CSVs, RUS (Random Under Sampling), and PRINTS metrics only (no file saves).
...
# -------- Preprocessing and RUS (Random Under Sampling) --------
...
# Apply RUS (Random Under Sampling)
print("\n⏳ Applying RUS (Random Under Sampling)...")
rus_start = time.time()
rus = RandomUnderSampler(random_state=42)
X_train_resampled, y_train_resampled = rus.fit_resample(X_train_prep, y_train)
rus_time = time.time() - rus_start

print(f"✅ RUS undersampling completed in {rus_time:.3f}s")
