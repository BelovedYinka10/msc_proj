...
from imblearn.under_sampling import ClusterCentroids  # ✅ Cluster Centroids undersampling
...
print("y_train shape before undersampling:", y_train.shape)

# ✅ Apply Cluster Centroids under-sampling
y_train_labels = np.argmax(y_train.values, axis=1)
cc = ClusterCentroids(random_state=42)
X_train, y_train_labels = cc.fit_resample(X_train, y_train_labels)
y_train = tf.keras.utils.to_categorical(y_train_labels, num_classes=y_test.shape[1])

print("y_train shape after undersampling:", y_train.shape)
