...
from imblearn.over_sampling import ADASYN  # <-- NEW
...
# ===== ADASYN oversampling on the training set ONLY =====
adasyn = ADASYN(random_state=42, n_neighbors=5)  # tweak n_neighbors if classes are very small
