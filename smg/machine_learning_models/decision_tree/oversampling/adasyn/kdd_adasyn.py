...
# Uses pre-made 5-class CSVs, ADASYN sampling, and PRINTS metrics only (no file saves).
...
# -------- Preprocessing and ADASYN Sampling --------
...
X_train_resampled, y_train_resampled = adasyn.fit_resample(X_train_prep, y_train)
adasyn_time = time.time() - adasyn_start

print(f"✅ ADASYN sampling completed in {adasyn_time:.3f}s")
...
# Since we're using ADASYN, we don't need class_weight balancing
if 'class_weight' in best_params:
    best_params.pop('class_weight')
    print("   Removed 'class_weight' parameter since ADASYN handles class imbalance")
