...
plt.title("Decision Tree (Final Fit) — Confusion Matrix")
plt.show()
...
with open('dt_baseline_results.json', 'w') as f:
    json.dump({
...
print("\n✅ Saved run metrics to 'dt_baseline_results.json'")

# Helper loader (same signature as before)
