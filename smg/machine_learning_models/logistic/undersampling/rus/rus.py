...
print("🚀 Logistic Regression with Random Under-Sampling (RUS) - Optimized Workflow")
print("="*70)
...
try:
    ...
    for class_idx, count in sorted(new_counts.items()):
        ...
        print(f"   Class {class_names[class_idx]}: {count} samples ({percentage:.1f}%) [{change} selected randomly]")
    
except ValueError as e:
    print(f"❌ RUS sampling failed: {e}")
...
print(f"\n⏳ Training Logistic Regression model on RUS-resampled data...")
...
print("\n" + "="*60)
print("🎯 LOGISTIC REGRESSION + RUS RESULTS")
print("="*60)
...
fig.update_layout(
    title={
        'text': 'Confusion Matrix - Logistic Regression + RUS',
        'x': 0.5,
        'xanchor': 'center',
...
print(f"🎲 Sampling: Random Under-Sampling (RUS)")
...
print(f"\n🎉 Logistic Regression + RUS experiment completed successfully!")