...
print("🚀 Logistic Regression with SMOTE - Optimized Workflow")
print("="*70)
...
print(f"\n⏳ Training Logistic Regression model on SMOTE-resampled data...")
...
fig.update_layout(
    title={
        'text': 'Confusion Matrix - Logistic Regression + SMOTE',
        'x': 0.5,
        'xanchor': 'center',
...
print(f"   - Logistic Regression + SMOTE (this experiment)")
print(f"   - XGBoost + SMOTE (next?)")

print(f"\n🎉 Logistic Regression + SMOTE experiment completed successfully!")