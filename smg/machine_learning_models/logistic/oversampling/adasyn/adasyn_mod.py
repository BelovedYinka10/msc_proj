...
print("🚀 Logistic Regression with ADASYN - Optimized Workflow")
print("="*70)
...
print(f"\n⏳ Training Logistic Regression model on ADASYN-resampled data...")
...
fig = go.Figure(data=go.Heatmap(
    ...
    colorscale='Purples',  # Different color for Logistic Regression
    showscale=True,
...
fig.update_layout(
    title={
        'text': 'Confusion Matrix - Logistic Regression + ADASYN',
        'x': 0.5,
        'xanchor': 'center',
...
print(f"   - Logistic Regression + ADASYN (this experiment)")
print(f"   - XGBoost + ADASYN (next?)")

print(f"\n🎉 Logistic Regression + ADASYN experiment completed successfully!")