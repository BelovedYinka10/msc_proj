...
print("🚀 Logistic Regression with BorderlineSMOTE - Optimized Workflow")
print("="*70)
...
try:
    ...
    print(f"❌ BorderlineSMOTE sampling failed: {e}")
...
print(f"\n⏳ Training Logistic Regression model on BorderlineSMOTE-resampled data...")
...
print("\n" + "="*60)
print("🎯 LOGISTIC REGRESSION + BORDERLINESMOTE RESULTS")
print("="*60)
...
fig.update_layout(
    title={
        'text': 'Confusion Matrix - Logistic Regression + BorderlineSMOTE',
        'x': 0.5,
        'xanchor': 'center',
...
print(f"   - Logistic Regression + BorderlineSMOTE (this experiment)")
print(f"   - XGBoost + BorderlineSMOTE (next?)")

print(f"\n🎉 Logistic Regression + BorderlineSMOTE experiment completed successfully!")