# Full code with NearMiss undersampling integrated
...
from imblearn.under_sampling import NearMiss  # Updated to NearMiss

nm = "NearMiss"  # Updated label for plots
...
y_train = y_train_onehot.idxmax(axis=1)  # NearMiss requires labels not one-hot
