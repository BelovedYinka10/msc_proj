...
from imblearn.under_sampling import TomekLinks  # ✅ TomekLinks undersampling
...
# ✅ Apply TomekLinks under-sampling
y_train_labels = np.argmax(y_train.values, axis=1)
tl = TomekLinks()
X_train, y_train_labels = tl.fit_resample(X_train, y_train_labels)
y_train = tf.keras.utils.to_categorical(y_train_labels, num_classes=y_test.shape[1])

print("y_train shape after TomekLinks:", y_train.shape)
