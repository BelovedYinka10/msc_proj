...
nm = NearMiss(version=1)  # You can change to version=2 or version=3 for variants
...
for class_name in class_labels:
    ...
    approx_acc = (metrics['precision'] * metrics['recall']) ** 0.5
    print(f"\nClass: {class_name}")
    print(f"  Accuracy (approx.): {approx_acc * 100:.2f}%")
