...
cnn_params = {
    'batch_size': 128,          # Updated from 32
    'filters1': 96,             # Updated from 64
    'dropout1': 0.4,            # Updated from 0.1
    'filters2': 128,            # Updated from 96
    'dropout2': 0.1,            # Updated from 0.2
    'dense_units': 192,         # Updated from 128
    'optimizer': 'adam',        # No change
    'lr': 0.003225943238477045  # Updated learning rate
}
