...
# Build model
def build_model(hp):
    hp.Choice('batch_size', [32, 64, 128, 256])  # ✅ Register batch_size properly
...
# Custom Tuner class to inject batch size
class MyTuner(kt.Hyperband):
    def run_trial(self, trial, *args, **kwargs):
        hp = trial.hyperparameters
        kwargs['batch_size'] = hp.get('batch_size')  # ✅ Use it during training
